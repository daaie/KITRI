...
void del_dol()
{
	if(pos_x==0&&pos_y==0) {position_xy(pos_x,pos_y); cout<<"┌";}
	else if(pos_x>0&&pos_x<40&&pos_y==0) {position_xy(pos_x,pos_y); cout<<"┬";}
	else if(pos_x==40&&pos_y==0) {position_xy(pos_x,pos_y); cout<<"┐";}
	else if(pos_x==0&&pos_y>0&&pos_y<20) {position_xy(pos_x,pos_y); cout<<"├";}
	else if(pos_x>0&&pos_x<40&&pos_y>0&&pos_y<20) {position_xy(pos_x,pos_y); cout<<"┼";}
	else if(pos_x==40&&pos_y>0&&pos_y<20){position_xy(pos_x,pos_y); cout<<"┤";}
	else if(pos_x==0&&pos_y==20){position_xy(pos_x,pos_y); cout<<"└";}
	else if(pos_x>0&&pos_x<20&&pos_y==20){position_xy(pos_x,pos_y); cout<<"┴";}
	else if(pos_x==40&&pos_y==20){position_xy(pos_x,pos_y); cout<<"┘";}
