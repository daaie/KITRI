...
CMy1031Dlg::CMy1031Dlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(IDD_MY1031_DIALOG, pParent)
{
...
BEGIN_MESSAGE_MAP(CMy1031Dlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON1, &CMy1031Dlg::OnBnClickedButton1)
END_MESSAGE_MAP()
...
void CMy1031Dlg::OnBnClickedButton1()
{
	CMySheet dlg;
	dlg.DoModal(); //모달 = 취소하기 눌러야 돌아감...
